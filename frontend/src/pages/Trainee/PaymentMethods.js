        ...
        <section className={style['main']}>
            ...
            <section className={style["payment-top"]}>
              <div>
                ...
                <label>Edit your payment methods and add/delete your credit cards here.</label>
              </div>
            </section>
          ...
          {rows.map((row,index) => (
            ...
            >
              ...
              **** **** **** {row.cardNumber.slice(11,15)}
              ...
              <TableCell align="right">{row.cardExpiryDate}</TableCell>
              <TableCell align="right"><ClearIcon onClick = {handleDelete} id ={row._id} style={{color:'red',cursor:"pointer"}}/></TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
            ...
            <section className={style["payment-bottom"]}>
               ...
               <form onSubmit={handleCreate}>
                ...
                <input required type="text"  placeholder={`Name on card`}   autoComplete="off" onChange={(e)=>setCardName(e.target.value)}></input>
                <label>Card number</label>
                <input required type="text" name="card-num" placeholder="0000 0000 0000 0000" size="18" id="cr_no" minLength={"16"} maxLength={"16"} value={cardNumber} onChange={validateNumber}></input>
                <label>CVV/CVC</label>
                <input required type="password" name="cvv" placeholder="000" size="1" minLength={"3"} maxLength="3" value={CVV} onChange={validateCVV}></input>
                <label>ExpiryDate</label>
                <input required ttype="text" name="exp" placeholder="MM/YY" size="6" id="exp" minLength="5" maxLength="5" onChange={validateDate}></input>
