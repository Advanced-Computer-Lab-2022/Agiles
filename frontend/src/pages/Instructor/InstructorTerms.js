...
import InstructorTermsStyles from "./InstructorTerms.module.css";
  ...
  return (
    <div className={InstructorTermsStyles["contract"]}>
      ...
      <p>
        ...
        assessments, and announcements ("Submitted Content").
      </p>
      ...
      <ul>
        <li>
          ...
          pornographic, false, misleading, incorrect, infringing, defamatory or
          libelous content or information;
        </li>
        <li>
      ...
      <p>
        ...
        instructors for any reason at any time, without prior notice, including
        in cases where:
      </p>
      <ul>
        <li>
        ...
        <li>
          content falls below our quality standards or has a negative impact on
      ...
      <p>
        Instructors don't have a direct contractual relationship with students,
      ...
      <p>
        ...
        certain promotional programs under the terms of our Promotions Policy
      ...
      <p>
        ...
        mobile app equivalent (as detailed below). If you opt to participate in
        a Promotional Program, we may set a different discounted price or list
        price for your Submitted Content as described in the Promotions Policy.
      </p>
      <p>
      ...
      <p>
        ...
        platform provider's pricing matrix will control, and we will choose the
        price tier closest to the applicable Base Price or Promotional Program
        price. Because mobile platforms impose their own currency conversion
        rates, conversions for mobile app prices may not match the conversions
        in the Price Tier Matrix.
      </p>
      <p>
        You give us permission to share your Submitted Content for free with our
        employees, with selected partners, and in cases where we need to restore
        access to accounts who have previously purchased your Submitted Content.
        You understand that you will not receive compensation in these cases.
      </p>
      ...
      <p>
        ...
        sale price at our discretion where we determine that such taxes may be
        due. For purchases through mobile applications, applicable Transaction
        Taxes are collected by the mobile platform (such as Apple's App Store or
        Google Play).
      </p>
      ...
      <p>
        There is no up-front cost to participate in these programs, and you can
        modify your participation status at any time, though changes you make
        will not apply to currently active campaigns and certain programs may
        have additional requirements on termination.
      </p>
      <h2>5. Payments</h2>
      ...
      <p>
        ...
        for any non-mobile provider checkout sales, and any amounts paid to
        third parties in connection with the Promotional Programs to calculate
        the net amount of the sale ("Net Amount").
      </p>
      <p>
        {" "}
        ...
        we change this payment rate, we will provide you 30 days notice using
        prominent means, such as via email or by posting a notice through our
        Services.{" "}
      </p>
      <p>
      ...
      <p>
        ...
        restrictions on these coupon codes and referral links are outlined in
        our Trust & Safety policies.
      </p>
      <p>
        Where a student applies your coupon code or referral link at checkout,
      ...
      <p>
        ...
        or U.S. bank account (for U.S. residents only) in good standing and must
        keep us informed of the correct email associated with your account. You
        must also provide any identifying information or tax documentation (such
        as a W-9 or W-8) necessary for payment of amounts due, and you agree
        that we have the right to withhold appropriate taxes from your payments.
        We reserve the right to withhold payments or impose other penalties if
        we do not receive proper identifying information or tax documentation
        from you. You understand and agree that you are ultimately responsible
        for any taxes on your income.
      </p>
      <p>
        Depending on the applicable revenue share model, payment will be made
        within 45 days of the end of the month in which (a) we receive the fee
        for a course or (b) the relevant course consumption occurred.
      </p>
      <p>
        As an instructor, you are responsible for determining whether you are
        eligible to be paid by a U.S. company. We reserve the right not to pay
        out funds in the event of identified fraud, violations of intellectual
        property rights, or other violations of the law.
      </p>
      <p>
        If we cannot settle funds into your payment account after the period of
        time set forth by your state, country, or other government authority in
        its unclaimed property laws, we may process the funds due to you in
        accordance with our legal obligations, including by submitting those
      ...
      <p>
        ...
        refund, as detailed in the Terms of Use. Instructors will not receive
        any revenue from transactions for which a refund has been granted under
        the Terms of Use.
      </p>
      <p>
        If a student asks for a refund after we have paid the relevant
        instructor payment, we reserve the right to either (1) deduct the amount
        of the refund from the next payment sent to the instructor or (2) where
        no further payments are due to the instructor or the payments are
        insufficient to cover the refunded amounts, require the instructor to
        refund any amounts refunded to students for the instructor's Submitted
        Content.
      </p>
      <h2>6. Trademarks</h2>
      <p>
      ...
      You must not: use our trademarks in a misleading or disparaging way; use
      our trademarks in a way that implies that we endorse, sponsor, or approve
      of your Submitted Content or services; or use our trademarks in a way that
      violates applicable law or in connection with an obscene, indecent, or
      ...
      <p>
        ...
        here. We'll use commercially reasonable efforts to make any remaining
        ...
        accessible to those students after your account is deleted. If you need
        help or encounter difficulty deleting your account, you can contact us
      ...
      <p>
        ...
        notice through our Services. Modifications will become effective on the
